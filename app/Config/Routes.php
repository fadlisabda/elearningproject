...
$routes->get('/kelassiswa/(:num)/(:any)', 'KelasSiswaController::index/$1/$2');
...
$routes->get('/kelasmapel/(:num)/(:any)', 'KelasMapelController::admin/$1/$2');
...
$routes->get('/kelasjampelajaran/(:num)/(:any)', 'KelasJamPelajaranController::index/$1/$2');
...
$routes->get('/eluser', 'EluserController::index');
...
$routes->get('/detailmapel/(:any)/(:any)/(:any)', 'DetailMapelController::index/$1/$2/$3');
...
$routes->get('/detailmapel/tugassiswa/(:num)', 'DetailMapelController::tugassiswa/$1');
