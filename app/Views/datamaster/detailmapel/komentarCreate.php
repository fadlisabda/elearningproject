...
<div class="container mt-3 mb-4">
    <div class="row">
        <div class="col">
            ...
            <form action="<?= base_url(); ?>/komentarController/saveKomentar/<?= $_GET['detailmapelsiswa']; ?>?namamapel=<?= $_GET['namamapel']; ?>&namakelas=<?= $_GET['namakelas']; ?>&namaguru=<?= $_GET['namaguru']; ?>&komentar=<?= $_GET['komentar']; ?>" method="post">
                <?= csrf_field(); ?>
                ...
                <a href="<?= base_url(); ?>/komentarcontroller/index/?detailmapelsiswa=<?= $_GET['detailmapelsiswa']; ?>&namamapel=<?= $_GET['namamapel']; ?>&namakelas=<?= $_GET['namakelas']; ?>&namaguru=<?= $_GET['namaguru'] ?>&komentar=<?= $_GET['komentar']; ?>" class="btn btn-danger">Kembali</a>
            </form>
            <script>
