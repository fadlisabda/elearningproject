        ...
        <div class="col-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url(); ?>/detailmapelcontroller/index/<?= $_GET['idkelas']; ?>/<?= $detailmapelsiswa['namamapel']; ?>/<?= $detailmapelsiswa['namakelas']; ?>/<?= $detailmapelsiswa['namaguru']; ?>" class="btn btn-warning mt-2">Kembali</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url() ?>/detailmapelcontroller/edit/<?= $detailmapelsiswa['id_detailmapel']; ?>?idkelas=<?= $_GET['idkelas']; ?>&namamapel=<?= $_GET['namamapel']; ?>&namakelas=<?= $_GET['namakelas']; ?>&namaguru=<?= $_GET['namaguru']; ?>" class="btn btn-dark mt-2">Tambah</a>

                        <a href="<?= base_url(); ?>/detailmapelcontroller/delete/<?= $detailmapelsiswa['id_detailmapel']; ?>?idkelas=<?= $_GET['idkelas']; ?>&namamapel=<?= $_GET['namamapel']; ?>&namakelas=<?= $_GET['namakelas']; ?>&namaguru=<?= $_GET['namaguru'] ?>" class="btn btn-danger mt-2" onclick="return confirm('apakah anda yakin?');">Batal</a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
