...
<div class="container mt-3 mb-4">
    <div class="row">
        <div class="col">
            ...
            <form action="<?= base_url(); ?>/kelasjampelajaran/update/<?= $kelasjampelajaran['id_jadwal']; ?>?id=<?= $id; ?>&namakelas=<?= $namakelas; ?>&page_kelas_jam_pelajaran=<?= $_GET['page_kelas_jam_pelajaran']; ?>" method="post">
                <?= csrf_field(); ?>
                <div class="mb-3">
