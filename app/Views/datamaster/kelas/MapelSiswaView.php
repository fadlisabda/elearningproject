    ...
    <?php foreach ($kelasmapelsiswa as $kms) : ?>
        <div class="col mb-4">
            <div class="card h-100">
                ...
                <div class="card-footer"><a href="<?= base_url(); ?>/detailmapelcontroller/index/<?= $kms->kelas_mapelid_kelas; ?>/<?= $kms->nama_mapel; ?>/<?= $kms->nama_kelas; ?>/<?= $kms->nama_guru; ?>" class="btn btn-info">Detail Mapel</a></div>
            </div>
        </div>
    <?php endforeach; ?>
    <?= $this->endSection(); ?>