...
<div class="container mt-3 mb-4">
    <div class="row">
        <div class="col">
            ...
            <form action="<?= base_url(); ?>/kelassiswa/save?id=<?= $id; ?>&namakelas=<?= $namakelas; ?>" method="post">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <a href="<?= base_url(); ?>/kelasSiswa/index/<?= $id; ?>/<?= $namakelas; ?>" class="btn btn-danger">Kembali</a>
            </form>
        </div>
    </div>
</div>
