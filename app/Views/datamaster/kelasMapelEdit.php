...
<div class="container mt-3 mb-4">
    <div class="row">
        <div class="col">
            ...
            <form action="<?= base_url(); ?>/kelasmapel/update/<?= $kelasmapel['id_kelas_mapel']; ?>?id=<?= $id; ?>&namakelas=<?= $namakelas; ?>" method="post">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <a href="<?= base_url(); ?>/kelasMapel/index/<?= $id; ?>/<?= $namakelas; ?>" class="btn btn-danger">Kembali</a>
            </form>
        </div>
    </div>
</div>
