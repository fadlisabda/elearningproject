...
<?php if ($_SESSION["status"] === 'admin') : ?>
    <a href="<?= base_url(); ?>/kelasjampelajaran/create?id=<?= $id; ?>&namakelas=<?= $namakelas; ?>" class="btn btn-primary float-end">Tambah Data Jam Pelajaran</a>
<?php endif; ?>
                ...
                <tr>
                    <?php if ($id === $kjpi['id_kelas']) : ?>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url(); ?>/kelasjampelajaran/delete/<?= $kjpi['id_jadwal']; ?>?id=<?= $id; ?>&namakelas=<?= $namakelas; ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin?');">Delete</a>
                        </td>
                    <?php endif; ?>
                </tr>
            <?php endforeach; ?>
