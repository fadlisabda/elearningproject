...
(1, '882947749', 'ali budimansyah', 'jakarta', '1968-02-11', '86338393947', 'jl sudirman', 'GVT_1619 edit biru.jpg', NULL, NULL, NULL),
(2, '5793989802', 'Thomas Alfa Edison', 'pekanbaru', '1978-09-27', '876488398', 'perawang barat', 'GVT_5247.jpg', NULL, NULL, NULL),
(3, '2234555', 'Arini Fitria', 'pekanbaru', NULL, '8848466589', 'jl umban sari', '', NULL, NULL, NULL),
(4, '12345346575', 'yuni hastuti', 'padang', NULL, '823456786', 'pandau permai', 'GVT_5303.jpg', NULL, NULL, NULL),
(5, '8840402728', 'ahmad dahlan', 'padang ', '1967-10-10', '882734778990', 'jl siak', 'GVT_5292.jpg', NULL, NULL, NULL),
(132, '1234455', 'willy', 'pekanbaru', '1996-03-11', '8232143553', 'pandau', 'karyawan.jpg', NULL, NULL, NULL);
...
CREATE TABLE `el_komentar` (
  ...
  `status` enum('kelas','pribadi') NOT NULL,
  `tipe` enum('guru','siswa') NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `el_tugas_siswa` (
  ...
  `filetugas` varchar(150) DEFAULT NULL,
  `linktugas` varchar(150) DEFAULT NULL,
...
(12, 4, 2, 'senin', '00:00:07', NULL, NULL, NULL),
(13, 5, 2, 'senin', '00:00:09', NULL, NULL, NULL),
(14, 9, 2, 'senin', '00:00:11', NULL, NULL, NULL),
(16, 5, 1, 'senin', '00:00:07', NULL, NULL, NULL),
(17, 4, 1, 'senin', '00:00:08', NULL, NULL, NULL),
(18, 4, 1, 'senin', '00:00:10', NULL, NULL, NULL),
(19, 14, 1, 'Senin', '00:00:10', NULL, NULL, NULL),
(20, 9, 1, 'senin', '00:00:12', NULL, NULL, NULL),
(21, 7, 1, 'senin', '00:00:13', NULL, NULL, NULL),
(22, 7, 1, 'senin', '00:00:13', NULL, NULL, NULL),
(23, 7, 1, 'senin', '00:00:13', NULL, NULL, NULL),
(24, 7, 1, 'senin', '00:00:13', NULL, NULL, NULL),
(25, 7, 1, 'senin', '00:00:13', NULL, NULL, NULL),
(26, 12, 1, 'senin', '00:00:14', NULL, NULL, NULL),
(27, 6, 1, 'senin', '00:00:15', NULL, NULL, NULL),
(28, 2, 7, 'Senin', '00:00:07', NULL, NULL, NULL),
(29, 4, 7, 'senin', '00:00:08', NULL, NULL, NULL),
(30, 4, 7, 'senin', '00:00:08', NULL, NULL, NULL),
(31, 10, 7, 'senin', '00:00:10', NULL, NULL, NULL),
(32, 9, 1, 'senin', '00:00:14', NULL, NULL, NULL),
(33, 10, 2, 'selasa', '00:00:07', NULL, '2021-10-11 07:54:50', NULL);
...
(11, 4, 1, '1234455', NULL, '2022-03-15 00:08:39', NULL),
...
(4, '3129164449', 2, '2021-03-03 04:07:22', '2022-03-19 23:00:54', NULL);
...
(1, '3115864953', '3115864953', 'ADZKIA QONITA', 'Pekanbaru', '2011-07-25', '81261238121', NULL, NULL, '', 3, '2021-02-24 05:03:59', '2021-10-07 00:12:05', NULL),
(2, '3129164448', '3129164448', 'AISYAH AFIQAH', 'Pekanbaru', '2012-07-16', '81261238121', NULL, NULL, NULL, 1, '2021-02-24 05:07:49', '2021-02-24 05:07:49', NULL),
(3, '123', '12345', 'Budi', 'Pekanbaru', '2000-01-01', '81261238121', NULL, NULL, NULL, 1, '2021-03-02 00:34:46', '2021-03-02 00:34:46', NULL),
(4, '3129164449', '3129164449', 'Ali', 'Pekanbaru', '2000-01-01', '81261238121', NULL, NULL, NULL, 6, '2021-03-03 04:04:30', '2021-03-03 04:05:08', NULL);
...
--
ALTER TABLE `data_guru`
  MODIFY `id_guru` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;
...
--
ALTER TABLE `el_user`
  MODIFY `id_eluser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `kelas_mapel`
  MODIFY `id_kelas_mapel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `kelas_siswa`
--
ALTER TABLE `kelas_siswa`
  MODIFY `id_kelas_siswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
