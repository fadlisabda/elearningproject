...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2021 at 05:23 PM
...
INSERT INTO `detail_mapel` (`id_detailmapel`, `namamapel`, `namakelas`, `namaguru`, `judul`, `keterangan`, `file`, `created_at`, `updated_at`, `deleted_at`) VALUES
(12, 'Kimia', 'I A', 'Arini Fitria', 'tugaskimia', 'kerjakan tugas ', 'Fhadly Sabda Dinov 183510802.pdf', '2021-08-19 10:11:00', '2021-08-19 10:11:00', NULL),
(13, 'Kimia', 'I A', 'willy', 'materikimia', 'bacapdf', 'Fhadly Sabda Dinov_183510802 - F.A.3.12.1 Formulir Pengajuan Tempat Praktek Kerja Lapangan.pdf', '2021-08-19 10:12:27', '2021-08-19 10:12:27', NULL);
...
(1, 'I A', '123', '2021-02-24 04:48:09', '2021-02-24 04:48:09', NULL),
(2, 'I B', '123', '2021-03-02 00:33:39', '2021-03-02 00:33:39', NULL);
...
--
-- Table structure for table `userelearning`
--

CREATE TABLE `userelearning` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `userelearning`
--

INSERT INTO `userelearning` (`id`, `username`, `password`, `status`) VALUES
(12, 'admin', '$2y$10$9fYsOKatgk9l78lamb/WU.aaYE7/FScZX92G8dKZnNlxJ0yzw2sDu', 'admin'),
(13, 'guru', '$2y$10$15vG.jQvlznLCTQs/sIBgunJKGaAiQSFoAj7HvMqAQld2fWilfHLe', 'guru'),
(14, 'siswa', '$2y$10$sn4qRDc.T8Y.aDgFy2UYhumVuzBwCX3yjBNEb2XHCaZCitDI3hxUG', 'siswa');
...
--
-- Indexes for table `userelearning`
--
ALTER TABLE `userelearning`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `data_mata_pelajaran`
  MODIFY `id_mapel` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `detail_mapel`
--
ALTER TABLE `detail_mapel`
  MODIFY `id_detailmapel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `kelas`
  MODIFY `id_kelas` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `kelas_siswa`
  MODIFY `id_kelas_siswa` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `userelearning`
--
ALTER TABLE `userelearning`
